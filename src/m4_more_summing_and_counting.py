...
def run_test_count_cosines_from():
    ...
    expected = 3
    answer = count_cosines_from(-2, 12, 0.7)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    expected = 3
    answer = count_cosines_from(7, 15, 0.4)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    expected = 5
    answer = count_cosines_from(-4, 10, 0.5)
...
def run_test_sum_unit_fractions_from():
    ...
    # ------------------------------------------------------------------
    expected = 1.818228  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(3, 15)
